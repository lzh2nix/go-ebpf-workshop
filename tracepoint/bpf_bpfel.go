...
type bpfWriteBytesMapKey struct {
	Pid         uint32
	TaskCommand [16]int8
	_           [4]byte
	Fd          uint64
...
type bpfMapSpecs struct {
	WriteBytesMap *ebpf.MapSpec `ebpf:"write_bytes_map"`
	WriteFdMap    *ebpf.MapSpec `ebpf:"write_fd_map"`
}
...
// It can be passed to loadBpfObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfMaps struct {
	WriteBytesMap *ebpf.Map `ebpf:"write_bytes_map"`
	WriteFdMap    *ebpf.Map `ebpf:"write_fd_map"`
}
